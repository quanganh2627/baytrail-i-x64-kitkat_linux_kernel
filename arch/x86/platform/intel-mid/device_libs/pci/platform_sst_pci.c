...
struct sst_ssp_info ssp_inf_ctp = {
	.gpio = {
...
struct sst_ssp_info ssp_inf_mrfld = {
...
struct sst_platform_debugfs_data ctp_debugfs_data = {
...
struct sst_platform_debugfs_data mrfld_debugfs_data = {
	.ssp_reg_size = SSP_SIZE,
...
static void set_mrfld_sst_config(struct sst_pci_info *sst_info)
{
