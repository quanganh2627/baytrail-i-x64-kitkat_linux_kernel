...
#define PROP_DSP_BUF_SIZE_DL2_OFFSET		"intel,dsp-buf-size-dl2-offset"
		...
		struct dsp_audio_device *dsp)
{
	...
	/* Buffer size DL2 offset */
	ret = of_property_read_u32(np,
			PROP_DSP_BUF_SIZE_DL2_OFFSET,
			&dsp->p_dsp_common_data->buf_size_dl2_offset);
