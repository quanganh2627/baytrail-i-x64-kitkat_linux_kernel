...
int bq2415x_attr_write(struct i2c_client *client,
				int attr,
				u8 val);

int bq2415x_attr_read(struct i2c_client *client,
				int attr,
				u8 *val);

enum charger_status {
	BQ2415x_STATUS_UNKNOWN,
	BQ2415x_STATUS_READY,
	BQ2415x_STATUS_FAULT,
};


/**
 * struct bq2415x_state - BQ2415x charger current state
...
/**
 * struct bq2415x_charger - BQ2415x charger driver internal structure
 ...
 *				path.
 * @debugfs_root_dir		debugfs bq2415x charger root directory
...
struct bq2415x_charger {
	...
	int (*configure_chip)(struct bq2415x_charger *chrgr,
					bool enable_charging);
	int (*enable_charger)(struct bq2415x_charger *chrgr, bool enable);
	int (*get_charger_state)(struct bq2415x_charger *chrgr);
	int (*get_clr_wdt_expiry_flag)(struct bq2415x_charger *chrgr);
	int (*calc_iocharge_regval)(struct bq2415x_charger *chrgr,
...
extern struct bq2415x_charger bq24158_chrgr_data;

int bq2415x_i2c_update_reg(struct i2c_client *client, u8 reg_addr,
