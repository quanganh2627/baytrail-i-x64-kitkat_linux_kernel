...
/**
 * struct rt9455_state - RT9455 charger current state
...
/**
 * struct rt9455_charger - RT9455 charger driver internal structure
 ...
 *				path.
 * @debugfs_root_dir		debugfs rt9455 charger root directory
...
struct rt9455_charger {
	...
	int (*configure_chip)(struct rt9455_charger *chrgr,
					bool enable_charging);
	int (*enable_charger)(struct rt9455_charger *chrgr, bool enable);
	int (*get_charger_state)(struct rt9455_charger *chrgr);
	int (*get_clr_wdt_expiry_flag)(struct rt9455_charger *chrgr);
	int (*calc_iocharge_regval)(struct rt9455_charger *chrgr,
...
extern struct rt9455_charger rt9455_chrgr_data;
