...
extern s32 gtp_i2c_read_dbl_check(struct i2c_client *,
	u16, u8 *, int);
...
#define CTP_CFG_GROUP1 {\
	0x42, 0xD0, 0x02, 0x00, 0x05, 0x0A, 0x35, 0x01, 0x01, 0x08, \
	0x28, 0x09, 0x50, 0x32, 0x03, 0x05, 0x00, 0x00, 0xFF, 0x7F, \
	0x00, 0x00, 0x00, 0x17, 0x19, 0x1E, 0x14, 0x8C, 0x2E, 0x0E, \
	0x4C, 0x4A, 0xD4, 0x07, 0x00, 0x00, 0x00, 0x9A, 0x33, 0x1D, \
	0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x0A, 0x00, \
	0x03, 0x32, 0x78, 0x94, 0xC5, 0x02, 0x07, 0x00, 0x00, 0x04, \
	0xAD, 0x36, 0x00, 0x90, 0x41, 0x00, 0x7B, 0x4D, 0x00, 0x6A, \
	0x5C, 0x00, 0x5B, 0x6E, 0x00, 0x5B, 0x18, 0x38, 0x60, 0x00, \
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
	0x00, 0x00, 0x18, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21, 0x22, \
	0x24, 0x26, 0x28, 0x29, 0x2A, 0x16, 0x14, 0x13, 0x12, 0x10, \
	0x0F, 0x0C, 0x0A, 0x08, 0x06, 0x04, 0x02, 0x00, 0x00, 0x00, \
	0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x11, 0x11, \
	0x11, 0xFF, 0xF3, 0xFF, 0x89, 0x01\
}
#elif defined (CONFIG_TOUCHSCREEN_GT911)
#define CTP_CFG_GROUP1 {\
	0x42, 0x58, 0x02, 0x00, 0x04, 0x0A, 0x35, 0x00, 0x01, 0x08, \
	0x1E, 0x08, 0x50, 0x32, 0x03, 0xF5, 0x00, 0x00, 0x00, 0x00, \
	0x00, 0x00, 0x00, 0x18, 0x1A, 0x1E, 0x14, 0x8C, 0x2E, 0x0E, \
	0x33, 0x35, 0x0F, 0x0A, 0x00, 0x00, 0x00, 0x02, 0x33, 0x1D, \
	0x00, 0x00, 0x00, 0x06, 0x00, 0x23, 0xFF, 0x7B, 0x14, 0x46, \
	0x32, 0x28, 0x5A, 0x94, 0xC5, 0x02, 0x07, 0x00, 0x00, 0x04, \
	0x92, 0x2B, 0x00, 0x80, 0x33, 0x00, 0x71, 0x3C, 0x00, 0x65, \
	0x46, 0x00, 0x5A, 0x53, 0x00, 0x5A, 0x00, 0x00, 0x00, 0x00, \
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
...
#define GTP_PLAT_D (i2c_connect_client->dev.platform_data)

/*  STEP_2(REQUIRED): Customize your I/O ports & I/O operations */
#define GTP_RST_PORT\
	(((struct gt9xx_ts_platform_data *)GTP_PLAT_D)->reset_pin)
#define GTP_INT_PORT\
	(((struct gt9xx_ts_platform_data *)GTP_PLAT_D)->irq_pin)
...
#define GTP_GPIO_AS_INT(pin)		\
	gt9xx_set_pinctrl_state(&i2c_connect_client->dev,\
	(((struct gt9xx_ts_platform_data *)\
	GTP_PLAT_D)->pins_default));

#define GTP_INT_SET_DEACTIVE(pin)	\
	gt9xx_set_pinctrl_state(&i2c_connect_client->dev,\
	(((struct gt9xx_ts_platform_data *)GTP_PLAT_D)->pins_inactive));

#define GTP_INT_SET_SLEEP(pin)		\
	gt9xx_set_pinctrl_state(&i2c_connect_client->dev,\
...
#define CFG_GROUP_LEN(p_cfg_grp) \
	(sizeof(p_cfg_grp) / sizeof(p_cfg_grp[0]))
/*  Log define */
