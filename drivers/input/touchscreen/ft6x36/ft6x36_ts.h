#ifndef __LINUX_FT6X36_TS_H__
#define __LINUX_FT6X36_TS_H__

/* -- dirver configure -- */
#define CFG_MAX_TOUCH_POINTS	2
#define MT_MAX_TOUCH_POINTS	2
...
/*register address*/
#define FT6X36_REG_FW_VER		0xA6
#define FT6X36_REG_POINT_RATE	0x88
#define FT6X36_REG_THGROUP	0x80

int ft6x36_i2c_Read(struct i2c_client *client, char *writebuf, int writelen,
