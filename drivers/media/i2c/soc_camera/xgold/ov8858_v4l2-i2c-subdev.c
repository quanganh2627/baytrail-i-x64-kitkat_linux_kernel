...
static const
struct ov_camera_module_reg OV8858_init_tab_3264_2448_15fps_R1A[] = {
	/*global setting*/
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0103, 0x01},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0100, 0x00},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0302, 0x1c},
...
static int ov8858_otp_read(struct ov_camera_module *cam_mod)
{
	...
	/*otp wb read*/
	ret = __ov8858_read_otp_wb(cam_mod);
	...
	/*otp vcm read*/
	ret = __ov8858_read_otp_vcm(cam_mod);
	...
	/*otp lenc read*/
	ret = __ov8858_read_otp_lenc(cam_mod);
