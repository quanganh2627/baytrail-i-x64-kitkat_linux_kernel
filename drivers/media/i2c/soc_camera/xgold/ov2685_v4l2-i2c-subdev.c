...
static const struct ov_camera_module_reg ov2685_initial_setting[] = {
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5184 , 0x84},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5185 , 0x52},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5186 , 0x83},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5187 , 0xa2},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5188 , 0x0c},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5189 , 0x12},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x518a , 0x0e},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x518b , 0x4f},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x518c , 0x36},
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x519b , 0x04},
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5280 , 0x15},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5281 , 0x0e},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5282 , 0x0f},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5283 , 0x13},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5284 , 0x1c},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5285 , 0x1c},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5286 , 0x20},
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5304 , 0x10},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5305 , 0x20},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5306 , 0x30},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5307 , 0x60},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5308 , 0x32},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5309 , 0x00},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x530a , 0x1d},
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5381 , 0x78},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5382 , 0x00},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5383 , 0x1C},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5384 , 0x00},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5385 , 0x7D},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5386 , 0x00},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5387 , 0x84},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5388 , 0x00},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5389 , 0x40},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x538a , 0x01},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x538b , 0xAE},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x538c , 0x10},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5400 , 0x0D},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5401 , 0x1A},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5402 , 0x32},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5403 , 0x59},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5404 , 0x68},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5405 , 0x76},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5406 , 0x82},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5407 , 0x8C},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5408 , 0x94},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5409 , 0x9C},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x540a , 0xA9},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x540b , 0xB6},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x540c , 0xCC},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x540d , 0xDD},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x540e , 0xEB},
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5481 , 0x09},
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5501 , 0x01},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5502 , 0x02},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5503 , 0x03},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5504 , 0x04},
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4002 , 0x00},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4003 , 0x0e},
...
static const struct ov_camera_module_reg ov2685_init_tab_2MP_15fps[] = {
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3814, 0x11},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3815, 0x11},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3820, 0xc4},
...
static const struct ov_camera_module_reg ov2685_init_tab_720P_30fps[] = {
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3815, 0x11},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3820, 0xc4},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3821, 0x4 },
...
static const struct ov_camera_module_reg ov2685_init_tab_VGA_30fps[] = {
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3820, 0xc6},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3821, 0x5 },
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x382a, 0x0 },
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3a00, 0x41},
...
static const struct ov_camera_module_reg ov2685_init_tab_SVGA_30fps[] = {
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3082, 0x2c},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380e, 0x02},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380f, 0xb9},  /* vblanking=4.6ms*/
