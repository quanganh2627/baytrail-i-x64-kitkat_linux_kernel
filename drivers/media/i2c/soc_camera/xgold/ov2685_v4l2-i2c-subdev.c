...
static const struct ov_camera_module_reg ov2685_init_tab_720P_30fps[] = {/*{{{*/
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x301d , 0xf0},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3020 , 0x00},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3082 , 0x29}, /* 26Mhz 0x37 */
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3083 , 0x03},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3084 , 0x0f},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3085 , 0x03},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3086 , 0x00},
...
static const struct ov_camera_module_reg ov2685_init_tab_VGA_30fps[] = {/*{{{*/
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x1000 , 0x01},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0129 , 0x10},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5180 , 0xf4},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5181 , 0x11},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5182 , 0x41},
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5183 , 0x42},
...
{/*{{{*/
	...
	if ((cam_mod->state == OV_CAMERA_MODULE_SW_STANDBY) ||
		...
		if (cam_mod->state == OV_CAMERA_MODULE_STREAMING)
			...
			OV2685_AEC_GROUP_UPDATE_ADDRESS,
			OV2685_AEC_GROUP_UPDATE_START_DATA);
		ret |= ov_camera_module_write_reg(cam_mod,
			OV2685_AEC_PK_LONG_GAIN_HIGH_REG,
			OV2685_FETCH_MSB_GAIN(a_gain));
		ret |= ov_camera_module_write_reg(cam_mod,
			OV2685_AEC_PK_LONG_GAIN_LOW_REG,
			OV2685_FETCH_LSB_GAIN(a_gain));
		ret = ov_camera_module_write_reg(cam_mod,
			OV2685_AEC_PK_LONG_EXPO_3RD_REG,
			OV2685_FETCH_3RD_BYTE_EXP(exp_time));
		ret |= ov_camera_module_write_reg(cam_mod,
			OV2685_AEC_PK_LONG_EXPO_2ND_REG,
			OV2685_FETCH_2ND_BYTE_EXP(exp_time));
		ret |= ov_camera_module_write_reg(cam_mod,
			OV2685_AEC_PK_LONG_EXPO_1ST_REG,
			OV2685_FETCH_1ST_BYTE_EXP(exp_time));
		if (cam_mod->state == OV_CAMERA_MODULE_STREAMING) {
			ret = ov_camera_module_write_reg(cam_mod,
				OV2685_AEC_GROUP_UPDATE_ADDRESS,
				OV2685_AEC_GROUP_UPDATE_END_DATA);
			ret = ov_camera_module_write_reg(cam_mod,
				OV2685_AEC_GROUP_UPDATE_ADDRESS,
				OV2685_AEC_GROUP_UPDATE_END_LAUNCH);
		}
	}
