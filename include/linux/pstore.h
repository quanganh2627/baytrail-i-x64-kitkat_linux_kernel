...
static inline int pstore_register_extra_dumper(struct pstore_extra_dumper *extra_dumper)
{
	return 0;
}
static inline int pstore_unregister_extra_dumper(struct pstore_extra_dumper *extra_dumper)
{
	return 0;
}
#endif
